...
export const CreateCharacterRequestSchema = z.object({
  ...
  avatarUrl: z.string().max(32_000).optional().default("/assets/character-avatar-default.svg"),
  coverImageUrl: z.string().max(32_000).optional().default("/assets/character-cover-default.svg"),
